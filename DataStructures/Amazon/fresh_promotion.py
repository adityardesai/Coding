...
def fresh_promotion(codeList, shoppingList):
    
    if codeList and not shoppingList: return 0
    
    if not codeList: return 1
    i=0
    j=0
    while i < len(codeList) and j+len(codeList[i]) <= len(shoppingList):
        match=True
        for k in range(len(codeList)):
            if codeList[i][k]!='anything' and codeList[i][k] != shoppingList[j+k]:
                match = False
                break
        if match:
            j+=len(codeList[i])
...
print(fresh_promotion([['apple', 'banana','apple', 'banana', 'coconut']], ['apple', 'banana', 'apple', 'banana', 'apple', 'banana']))
print(fresh_promotion([['apple', 'orange'], ['orange', 'banana', 'orange']], ['apple', 'orange', 'banana', 'orange', 'orange', 'banana', 'orange', 'grape']))
print(fresh_promotion([['apple', 'apple'], ['banana', 'anything', 'banana']], ['apple', 'apple', 'banana', 'banana']))
print(fresh_promotion([['apple', 'apple'], ['apple', 'anything', 'banana']], ['apple', 'apple', 'banana', 'banana']))
print(fresh_promotion([['apple', 'apple'], ['apple', 'anything', 'banana']], ['apple', 'apple', 'apple', 'apple', 'banana']))
print(fresh_promotion([['apple', 'apple'], ['apple', 'banana']], ['apple', 'apple', 'apple', 'banana']))
print(fresh_promotion([["anything", "apple" ], ["banana", "anything", "banana"]], ["orange", "grapes", "apple", "orange", "orange", "banana", "apple", "banana", "banana"]))
print(fresh_promotion([['anything']], ['apple', 'apple', 'apple', 'banana']))
